...
export default function Comparison() {
  ...
  return (
    <div className="min-h-screen bg-[#060C1E] p-3 sm:p-4 md:p-5 lg:p-6 flex flex-col">
      <ParticlesBackground />
...
class AuthService:
    ...
    async def create_session(self, user_id: str):
      ...
      <div className="mt-auto pt-6 flex justify-start sm:justify-end">
        <button
          className="bg-[#10B981] font-medium px-4 py-2 rounded-lg hover:bg-[#0d9668] transition-colors"
